...
/* THIS IMPLEMENTATION DOES NOT WORK, IT ISN'T USED - This is an attempted implementation based off of the work in learnopengl spotlight tutorial */
...
public class SecurityLight {
  ...
  public SecurityLight(GL3 gl) {
    ...
    model = new Mat4(1);
    cutOff = 0.5f;
    this.spotlightDirection = new Vec3(0f, -1f, 0f);
    
    fillBuffers(gl);
    shader = new Shader(gl, "shaders/vs_light_02.txt", "shaders/fs_light_02.txt");
  }
  ...
  public void render(GL3 gl) { //, Mat4 perspective, Mat4 view) {
    ...
    shader.use(gl);
    shader.setVec3(gl, "light.position", camera.getPosition());
